...
3. Keep `PanelView::Main` / `Settings` / `Help`. Do not drop Settings, How to use, or the glass fallback on grouped cards. The panel is an independent titled window, not a menu-attached popover.
